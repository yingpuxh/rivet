...
namespace Rivet {
  ...
  public:
	...
	_h_toppt          = bookHisto1D("toppt",              26,  200.,  1500.);
      ...
      _h_htmiss		  = bookHisto1D("htmiss",             27,   100.0,   2800.);
      ...
      _h_ht               = bookHisto1D("ht",    	      28, 200.0,  3000.);
      ...
      _h_regularjetssize  = bookHisto1D("regularjetssize",     9,   2.,   11.);
      _h_bjetssize        = bookHisto1D("bjetssize",           5,   0.,   5.);
