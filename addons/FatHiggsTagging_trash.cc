  ...
  if(js.size()==2){
    if(btags==0){
      if(ht >200 && ht< 400){
        ...
        if(sum_jet.pT()<400 && sum_jet.pT()>200)
        _h_cutflow->fill(8., event.weight());
    ...
    if(btags==2){
      if(ht >200 && ht< 400){
        ...
        if(sum_jet.pT()>200 && sum_jet.pT()<400){
        _h_ch8sig->fill(130., event.weight());
        _h_cutflow->fill(38., event.weight());}
        if(sum_jet.pT()>400 && sum_jet.pT()<600){
  ...
  if(js.size()==4){
    ...
    if(btags==3){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(40., event.weight());}  
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400 && sum_jet.pT()>200)
  ...
  if(js.size()==5){
    if(btags==0){
      ...
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(70., event.weight());}
      else {
        if(sum_jet.pT()<400 && sum_jet.pT()>200){
      ...
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(82., event.weight());}
      else {
        if(sum_jet.pT()<400 && sum_jet.pT()>200){
        _h_ch22sig->fill(130., event.weight());
        _h_cutflownjet4->fill(83., event.weight());}
        else if(sum_jet.pT()>400 && sum_jet.pT()<600){
        ...
        else{ _h_cutflownjet4->fill(86., event.weight());
      ...
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(289., event.weight());}  
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400 && sum_jet.pT()>200)
      ...
      if(sum_jet.pT()>200 && sum_jet.pT()<400)
      _h_cutflownjet4->fill(233., event.weight());
      else _h_cutflownjet4->fill(233., event.weight());}
      }
  }
