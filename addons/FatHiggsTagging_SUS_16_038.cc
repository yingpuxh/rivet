...
namespace Rivet {
  ...
  public:
	...
	_h_toppt          = bookHisto1D("toppt",              26,  200.,  1500.);
      ...
      _h_cutflow          = bookHisto1D("cutflow",           89,  -0.5,    88.5);
      _h_cutflownjet4     = bookHisto1D("cutflownjet4",      135,  -0.5,    134.5);
    ...
    void analyze(const Event& event) {
      ...
      const Jets& calojets  = apply<FastJets>(event, "calojets").jetsByPt(Cuts::pT > 40*GeV && Cuts::abseta < 5.0);
...
//      vector <string> trackflavors; trackflavors.clear();
      ...
      for (unsigned ifjet = 0 ; ifjet < js.size(); ifjet++) {
       ...
       if (js[ifjet].perp()/GeV>40 && js[ifjet].abseta()<2.4){
       int isbtagg(0.0);
       double eff(0.0);
...
// missing CHF selection
  ...
  if(js.size()==1){
    if(btags==0){
      ...
      _h_cutflow->fill(1., event.weight());
      else if(ht >600 && ht< 900)
      _h_cutflow->fill(2., event.weight());
      else _h_cutflow->fill(3., event.weight());}
    else if(btags==1){
      if(ht >200 && ht< 400)
      _h_cutflow->fill(4., event.weight());
      else if(ht >400 && ht< 600)
  ...
  if(js.size()==2){
    if(btags==0){
      if(ht >200 && ht< 400)
        ...
        if(sum_jet.pT()<400)
        _h_cutflow->fill(8., event.weight());
        else _h_cutflow->fill(9., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(10., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(11., event.weight());
        else _h_cutflow->fill(12., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(13., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(14., event.weight());
        else if(sum_jet.pT()>600 && sum_jet.pT()<900)
        _h_cutflow->fill(15., event.weight());
        else _h_cutflow->fill(16., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        _h_cutflow->fill(19., event.weight());}
      else{
    ...
    if(btags==1){
      if(ht >200 && ht< 400)
        ...
        else _h_cutflow->fill(23., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(24., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(25., event.weight());
        else _h_cutflow->fill(26., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        ...
        else{ _h_cutflow->fill(34., event.weight());
        }}
      }
    if(btags==2){
      if(ht >200 && ht< 400)
        ...
        else _h_cutflow->fill(37., event.weight());}
      else {
        if(sum_jet.pT()<400)
        _h_cutflow->fill(38., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(39., event.weight());
        else _h_cutflow->fill(40., event.weight());}
      }
  }
  ...
  if(js.size()==3){
    if(btags==0){
      if(ht >200 && ht< 400){
        ...
        else _h_cutflow->fill(43., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(44., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(45., event.weight());
        else _h_cutflow->fill(46., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(47., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(48., event.weight());
        else if(sum_jet.pT()>600 && sum_jet.pT()<900)
        _h_cutflow->fill(49., event.weight());
        else _h_cutflow->fill(50., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        else{ _h_cutflow->fill(54., event.weight());
        }}
      }
    ...
    if(btags==1){
      if(ht >200 && ht< 400){
        ...
        else _h_cutflow->fill(57., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(58., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(59., event.weight());
        else _h_cutflow->fill(60., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        ...
        else _h_cutflow->fill(64., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        else{ _h_cutflow->fill(68., event.weight());
        }}
      }
    ...
    if(btags==2){
      if(ht >200 && ht< 400){
        ...
        else _h_cutflow->fill(71., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflow->fill(72., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(73., event.weight());
        else _h_cutflow->fill(74., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400){
        ...
        _h_cutflow->fill(77., event.weight());}
        else{ _h_cutflow->fill(78., event.weight());
        }}
      else {
        if(sum_jet.pT()<400){
        ...
        _h_cutflow->fill(81., event.weight());}
        else{ _h_cutflow->fill(82., event.weight());
        }}
      }
    ...
    if(btags==3){
      if(ht >200 && ht< 400){
        ...
        else _h_cutflow->fill(85., event.weight());}
      else{
        if(sum_jet.pT()<400)
        _h_cutflow->fill(86., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflow->fill(87., event.weight());
        else _h_cutflow->fill(88., event.weight());}
      }
  }
  ...
  if(js.size()==4){
    if(btags==0){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(1., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        ...
        else _h_cutflownjet4->fill(8., event.weight());}
      else {
        if(sum_jet.pT()<400){
        _h_cutflownjet4->fill(9., event.weight());}
        else if(sum_jet.pT()>400 && sum_jet.pT()<600){
        _h_cutflownjet4->fill(10., event.weight());}
        else if(sum_jet.pT()>600 && sum_jet.pT()<900){
        _h_cutflownjet4->fill(11., event.weight());}
        else{ _h_cutflownjet4->fill(12., event.weight());
        }}
      }
    ...
    if(btags==1){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(14., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(15., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(16., event.weight());
        else _h_cutflownjet4->fill(17., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(18., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(19., event.weight());
        else if(sum_jet.pT()>600 && sum_jet.pT()<900)
        _h_cutflownjet4->fill(20., event.weight());
        else _h_cutflownjet4->fill(21., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        else{ _h_cutflownjet4->fill(25., event.weight());
        }}
      }
    ...
    if(btags==2){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(27., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(28., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(29., event.weight());
        else _h_cutflownjet4->fill(30., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        ...
        else _h_cutflownjet4->fill(34., event.weight());}
      else {
        if(sum_jet.pT()<400){
    ...
    if(btags==3){
      if(ht >400 && ht< 600){
        ...
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(41., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(42., event.weight());
        else _h_cutflownjet4->fill(43., event.weight());}
      else {
        if(sum_jet.pT()<400)
        ...
        else _h_cutflownjet4->fill(47., event.weight());}
      }
  }
  ...
  if(js.size()==5){
    if(btags==0){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(49., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(50., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(51., event.weight());
        else _h_cutflownjet4->fill(52., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        ...
        else _h_cutflownjet4->fill(59., event.weight());}
      }

    if(btags==1){
      if(ht >400 && ht< 600){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(60., event.weight());
        else _h_cutflownjet4->fill(61., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(62., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(63., event.weight());
        else _h_cutflownjet4->fill(64., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(65., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(66., event.weight());
        else _h_cutflownjet4->fill(67., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        else{ _h_cutflownjet4->fill(71., event.weight());
        }}
      }
    ...
    if(btags==2){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(73., event.weight());}
      else if(ht >600 && ht< 900){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(74., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(75., event.weight());
        else _h_cutflownjet4->fill(76., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(77., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(78., event.weight());
        else _h_cutflownjet4->fill(79., event.weight());}
      else {
        if(sum_jet.pT()<400){
  ...
  if(js.size() >5){
    if(btags==0){
      if(ht >400 && ht< 600){
        ...
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(95., event.weight());
        else _h_cutflownjet4->fill(96., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(97., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(98., event.weight());
        else _h_cutflownjet4->fill(99., event.weight());}
      else {
        if(sum_jet.pT()<400)
        ...
        else _h_cutflownjet4->fill(103., event.weight());}
      }
    ...
    if(btags==1){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(106., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
    ...
    if(btags==2){
      if(ht >400 && ht< 600){
        ...
        else _h_cutflownjet4->fill(116., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(117., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(118., event.weight());
        else _h_cutflownjet4->fill(119., event.weight());}
      else {
        if(sum_jet.pT()<400){
        ...
        else{ _h_cutflownjet4->fill(123., event.weight());
        }}
      }
    if(btags==3){
      if(ht >400 && ht< 600){
        ...
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(125., event.weight());
        else _h_cutflownjet4->fill(126., event.weight());}
      else if(ht >900 && ht< 1200){
        if(sum_jet.pT()<400)
        _h_cutflownjet4->fill(127., event.weight());
        else if(sum_jet.pT()>400 && sum_jet.pT()<600)
        _h_cutflownjet4->fill(128., event.weight());
        else _h_cutflownjet4->fill(129., event.weight());}
      else {
        if(sum_jet.pT()<400)
        ...
        _h_cutflownjet4->fill(132., event.weight());
        else _h_cutflownjet4->fill(133., event.weight());}
      }
    if(btags >3){
      if(ht >400 && ht< 600)
